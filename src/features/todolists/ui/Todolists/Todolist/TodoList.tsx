...
import {changeTodoListTitle,  removeTodolistAC, Todolist} from "../../../model/todolists-reducer";
...
export const TodoList = ({todoList, tasks,}: Props) => {
    ...
    return (
        <Paper elevation = {2} sx = {{p: '20px'}}>
            <TodolistTitle title = {todoList.title} updateTodoListTitle = {updateTodoListTitle}
