...
function App() {
    ...
    let [todolists, dispatchToTodolists] = useReducer<Reducer<TodolistType[], TodoListActionsType>>(todolistsReducer, [
        {id: todolistId1, title: "What to learn", filter: "all"},
        {id: todolistId2, title: "What to buy", filter: "all"}
    ])

    let [tasks, dispatchToTasks] = useReducer<Reducer<TasksStateType, TasksActionsType>>(tasksReducer, {
        [todolistId1]: [
